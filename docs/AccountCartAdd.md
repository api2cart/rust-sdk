...
**store_key** | Option<**String**> | If a bridge connector is already installed on the store, you MUST pass here the store key it generated during installation, to connect via the bridge-based integration. Omit it only when connecting via an API-based integration, which uses API credentials instead. | [optional]
**label** | Option<**String**> | Defines alternative text that has to be attached to the picture | [optional]
**custom_label** | Option<**String**> | Defines a custom label for the store in the app | [optional]
...
**americommerce_app_id** | Option<**String**> | Americommerce App ID | [optional]
**americommerce_app_secret** | Option<**String**> | Americommerce App Secret | [optional]
**americommerce_access_token** | Option<**String**> | Americommerce Access Token | [optional]
**americommerce_refresh_token** | Option<**String**> | Americommerce Refresh Token | [optional]
...
**nopcommerce_token** | Option<**String**> | Access token authorizing the app to access resources on behalf of a user | [optional]
**nopcommerce_secret** | Option<**String**> | nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it. | [optional]
...
**walmart_refresh_token** | Option<**String**> | Walmart refresh token received by a Solution Provider application through the Walmart App Store authorization. When it is set, walmart_client_id and walmart_client_secret are the credentials of that application, not of the seller. Must be used together with walmart_seller_id and is supported only for walmart_region = 'us' | [optional]
**walmart_seller_id** | Option<**String**> | Walmart seller id the refresh token was issued for, sent as the WM_PARTNER.ID header. Must be used together with walmart_refresh_token and is supported only for walmart_region = 'us' | [optional]
...
**shopify_client_id** | Option<**String**> | Shopify Client ID | [optional]
...
**unas_api_key** | Option<**String**> | UNAS API Key | [optional]
...
**jumpseller_client_id** | Option<**String**> | Jumpseller OAuth2 Client ID | [optional]
**jumpseller_client_secret** | Option<**String**> | Jumpseller OAuth2 Client Secret | [optional]
**jumpseller_refresh_token** | Option<**String**> | Jumpseller OAuth2 refresh token | [optional]
**jumpseller_login** | Option<**String**> | Jumpseller API login | [optional]
**jumpseller_authtoken** | Option<**String**> | Jumpseller API auth token | [optional]
...
**scapi_client_id** | Option<**String**> | Salesforce Commerce API Client ID | [optional]
**scapi_client_secret** | Option<**String**> | Salesforce Commerce API Client Secret | [optional]
**scapi_organization_id** | Option<**String**> | Salesforce Commerce Organization ID | [optional]
**scapi_short_code** | Option<**String**> | Salesforce Commerce Short Code | [optional]
**scapi_scopes** | Option<**String**> | Salesforce Commerce API Scopes | [optional]
