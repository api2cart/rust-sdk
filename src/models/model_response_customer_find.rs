...
pub struct ModelResponseCustomerFind {
    ...
    pub result: Option<Option<Box<models::ResponseCustomerFindResult>>>,
...
impl ModelResponseCustomerFind {
    pub fn new() -> ModelResponseCustomerFind {
