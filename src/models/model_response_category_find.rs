...
pub struct ModelResponseCategoryFind {
    ...
    pub result: Option<Option<Box<models::ResponseCategoryFindResult>>>,
...
impl ModelResponseCategoryFind {
    pub fn new() -> ModelResponseCategoryFind {
