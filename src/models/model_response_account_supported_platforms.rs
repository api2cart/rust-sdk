...
pub struct ModelResponseAccountSupportedPlatforms {
    ...
    pub result: Option<Option<Box<models::ResponseAccountSupportedPlatformsResult>>>,
...
impl ModelResponseAccountSupportedPlatforms {
    pub fn new() -> ModelResponseAccountSupportedPlatforms {
