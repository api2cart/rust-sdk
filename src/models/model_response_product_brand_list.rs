...
pub struct ModelResponseProductBrandList {
    ...
    pub result: Option<Option<Box<models::ResponseProductBrandListResult>>>,
...
impl ModelResponseProductBrandList {
    pub fn new() -> ModelResponseProductBrandList {
