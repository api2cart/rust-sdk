...
pub struct ModelResponseCartMethods {
    ...
    pub result: Option<Option<Box<models::ResponseCartMethodsResult>>>,
...
impl ModelResponseCartMethods {
    pub fn new() -> ModelResponseCartMethods {
