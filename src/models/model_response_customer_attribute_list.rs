...
pub struct ModelResponseCustomerAttributeList {
    ...
    pub result: Option<Option<Box<models::ResponseCustomerAttributeListResult>>>,
...
impl ModelResponseCustomerAttributeList {
    pub fn new() -> ModelResponseCustomerAttributeList {
