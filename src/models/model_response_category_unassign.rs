...
pub struct ModelResponseCategoryUnassign {
    ...
    pub result: Option<Option<Box<models::ResponseCategoryUnassignResult>>>,
...
impl ModelResponseCategoryUnassign {
    pub fn new() -> ModelResponseCategoryUnassign {
