...
pub struct ModelResponseProductAttributeList {
    ...
    pub result: Option<Option<Box<models::ResponseProductAttributeListResult>>>,
...
impl ModelResponseProductAttributeList {
    pub fn new() -> ModelResponseProductAttributeList {
