...
pub struct ModelResponseCustomerWishlistList {
    ...
    pub result: Option<Option<Box<models::ResponseCustomerWishlistListResult>>>,
...
impl ModelResponseCustomerWishlistList {
    pub fn new() -> ModelResponseCustomerWishlistList {
