...
pub struct ModelResponseAttributeCount {
    ...
    pub result: Option<Option<Box<models::ResponseAttributeCountResult>>>,
...
impl ModelResponseAttributeCount {
    pub fn new() -> ModelResponseAttributeCount {
