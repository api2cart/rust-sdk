...
pub struct ModelResponseCartShippingZonesList {
    ...
    pub result: Option<Option<Box<models::ResponseCartShippingZonesListResult>>>,
...
impl ModelResponseCartShippingZonesList {
    pub fn new() -> ModelResponseCartShippingZonesList {
