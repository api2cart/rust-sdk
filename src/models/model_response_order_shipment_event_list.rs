...
pub struct ModelResponseOrderShipmentEventList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderShipmentEventListResult>>>,
...
impl ModelResponseOrderShipmentEventList {
    pub fn new() -> ModelResponseOrderShipmentEventList {
