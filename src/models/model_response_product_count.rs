...
pub struct ModelResponseProductCount {
    ...
    pub result: Option<Option<Box<models::ResponseProductCountResult>>>,
...
impl ModelResponseProductCount {
    pub fn new() -> ModelResponseProductCount {
