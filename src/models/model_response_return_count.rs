...
pub struct ModelResponseReturnCount {
    ...
    pub result: Option<Option<Box<models::ResponseReturnCountResult>>>,
...
impl ModelResponseReturnCount {
    pub fn new() -> ModelResponseReturnCount {
