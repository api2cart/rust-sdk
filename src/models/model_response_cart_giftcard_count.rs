...
pub struct ModelResponseCartGiftcardCount {
    ...
    pub result: Option<Option<Box<models::ResponseCartGiftcardCountResult>>>,
...
impl ModelResponseCartGiftcardCount {
    pub fn new() -> ModelResponseCartGiftcardCount {
