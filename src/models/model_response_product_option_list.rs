...
pub struct ModelResponseProductOptionList {
    ...
    pub result: Option<Option<Box<models::ResponseProductOptionListResult>>>,
...
impl ModelResponseProductOptionList {
    pub fn new() -> ModelResponseProductOptionList {
