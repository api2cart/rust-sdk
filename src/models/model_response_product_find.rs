...
pub struct ModelResponseProductFind {
    ...
    pub result: Option<Option<Box<models::ResponseProductFindResult>>>,
...
impl ModelResponseProductFind {
    pub fn new() -> ModelResponseProductFind {
