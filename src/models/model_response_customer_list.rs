...
pub struct ModelResponseCustomerList {
    ...
    pub result: Option<Option<Box<models::ResponseCustomerListResult>>>,
...
impl ModelResponseCustomerList {
    pub fn new() -> ModelResponseCustomerList {
