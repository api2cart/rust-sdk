...
pub struct ModelResponseOrderStatusList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderStatusListResult>>>,
...
impl ModelResponseOrderStatusList {
    pub fn new() -> ModelResponseOrderStatusList {
