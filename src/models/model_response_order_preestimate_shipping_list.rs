...
pub struct ModelResponseOrderPreestimateShippingList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderPreestimateShippingListResult>>>,
...
impl ModelResponseOrderPreestimateShippingList {
    pub fn new() -> ModelResponseOrderPreestimateShippingList {
