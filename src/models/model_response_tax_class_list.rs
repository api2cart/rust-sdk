...
pub struct ModelResponseTaxClassList {
    ...
    pub result: Option<Option<Box<models::ResponseTaxClassListResult>>>,
...
impl ModelResponseTaxClassList {
    pub fn new() -> ModelResponseTaxClassList {
