...
pub struct ModelResponseAttributeTypeList {
    ...
    pub result: Option<Option<Box<models::ResponseAttributeTypeListResult>>>,
...
impl ModelResponseAttributeTypeList {
    pub fn new() -> ModelResponseAttributeTypeList {
