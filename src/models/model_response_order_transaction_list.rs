...
pub struct ModelResponseOrderTransactionList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderTransactionListResult>>>,
...
impl ModelResponseOrderTransactionList {
    pub fn new() -> ModelResponseOrderTransactionList {
