...
pub struct ModelResponseCustomerGroupList {
    ...
    pub result: Option<Option<Box<models::ResponseCustomerGroupListResult>>>,
...
impl ModelResponseCustomerGroupList {
    pub fn new() -> ModelResponseCustomerGroupList {
