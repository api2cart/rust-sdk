...
pub struct ModelResponseReturnActionList {
    ...
    pub result: Option<Option<Box<models::ResponseReturnActionListResult>>>,
...
impl ModelResponseReturnActionList {
    pub fn new() -> ModelResponseReturnActionList {
