...
pub struct ModelResponseProductList {
    ...
    pub result: Option<Option<Box<models::ResponseProductListResult>>>,
...
impl ModelResponseProductList {
    pub fn new() -> ModelResponseProductList {
