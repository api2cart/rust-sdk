...
pub struct ModelResponseCartGiftCardList {
    ...
    pub result: Option<Option<Box<models::ResponseCartGiftcardListResult>>>,
...
impl ModelResponseCartGiftCardList {
    pub fn new() -> ModelResponseCartGiftCardList {
