...
pub struct ModelResponseCategoryAssign {
    ...
    pub result: Option<Option<Box<models::ResponseCategoryAssignResult>>>,
...
impl ModelResponseCategoryAssign {
    pub fn new() -> ModelResponseCategoryAssign {
