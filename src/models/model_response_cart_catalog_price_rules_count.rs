...
pub struct ModelResponseCartCatalogPriceRulesCount {
    ...
    pub result: Option<Option<Box<models::ResponseCartCatalogPriceRulesCountResult>>>,
...
impl ModelResponseCartCatalogPriceRulesCount {
    pub fn new() -> ModelResponseCartCatalogPriceRulesCount {
