...
pub struct ModelResponseReturnStatusList {
    ...
    pub result: Option<Option<Box<models::ResponseReturnStatusListResult>>>,
...
impl ModelResponseReturnStatusList {
    pub fn new() -> ModelResponseReturnStatusList {
