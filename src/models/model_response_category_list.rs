...
pub struct ModelResponseCategoryList {
    ...
    pub result: Option<Option<Box<models::ResponseCategoryListResult>>>,
...
impl ModelResponseCategoryList {
    pub fn new() -> ModelResponseCategoryList {
