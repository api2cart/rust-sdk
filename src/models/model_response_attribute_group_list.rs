...
pub struct ModelResponseAttributeGroupList {
    ...
    pub result: Option<Option<Box<models::ResponseAttributeGroupListResult>>>,
...
impl ModelResponseAttributeGroupList {
    pub fn new() -> ModelResponseAttributeGroupList {
