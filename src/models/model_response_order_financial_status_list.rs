...
pub struct ModelResponseOrderFinancialStatusList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderFinancialStatusListResult>>>,
...
impl ModelResponseOrderFinancialStatusList {
    pub fn new() -> ModelResponseOrderFinancialStatusList {
