...
pub struct ModelResponseWebhookEvents {
    ...
    pub result: Option<Option<Box<models::ResponseWebhookEventsResult>>>,
...
impl ModelResponseWebhookEvents {
    pub fn new() -> ModelResponseWebhookEvents {
