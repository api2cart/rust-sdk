...
pub struct ModelResponseCartScriptList {
    ...
    pub result: Option<Option<Box<models::ResponseCartScriptListResult>>>,
...
impl ModelResponseCartScriptList {
    pub fn new() -> ModelResponseCartScriptList {
