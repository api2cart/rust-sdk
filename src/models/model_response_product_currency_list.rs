...
pub struct ModelResponseProductCurrencyList {
    ...
    pub result: Option<Option<Box<models::ResponseProductCurrencyListResult>>>,
...
impl ModelResponseProductCurrencyList {
    pub fn new() -> ModelResponseProductCurrencyList {
