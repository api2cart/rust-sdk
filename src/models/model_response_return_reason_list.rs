...
pub struct ModelResponseReturnReasonList {
    ...
    pub result: Option<Option<Box<models::ResponseReturnReasonListResult>>>,
...
impl ModelResponseReturnReasonList {
    pub fn new() -> ModelResponseReturnReasonList {
