...
pub struct ResponseCartMetaDataListResult {
    ...
    pub items: Option<Vec<models::CartMetaData>>,
...
impl ResponseCartMetaDataListResult {
    pub fn new() -> ResponseCartMetaDataListResult {
