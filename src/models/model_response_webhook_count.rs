...
pub struct ModelResponseWebhookCount {
    ...
    pub result: Option<Option<Box<models::ResponseWebhookCountResult>>>,
...
impl ModelResponseWebhookCount {
    pub fn new() -> ModelResponseWebhookCount {
