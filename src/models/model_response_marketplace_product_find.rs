...
pub struct ModelResponseMarketplaceProductFind {
    ...
    pub result: Option<Option<Box<models::ResponseMarketplaceProductFindResult>>>,
...
impl ModelResponseMarketplaceProductFind {
    pub fn new() -> ModelResponseMarketplaceProductFind {
