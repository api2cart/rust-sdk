...
pub struct ModelResponseCartMetaDataList {
    ...
    pub result: Option<Option<Box<models::ResponseCartMetaDataListResult>>>,
...
impl ModelResponseCartMetaDataList {
    pub fn new() -> ModelResponseCartMetaDataList {
