...
pub struct ModelResponseProductChildItemFind {
    ...
    pub result: Option<Option<Box<models::ResponseProductChildItemFindResult>>>,
...
impl ModelResponseProductChildItemFind {
    pub fn new() -> ModelResponseProductChildItemFind {
