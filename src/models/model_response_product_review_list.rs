...
pub struct ModelResponseProductReviewList {
    ...
    pub result: Option<Option<Box<models::ResponseProductReviewListResult>>>,
...
impl ModelResponseProductReviewList {
    pub fn new() -> ModelResponseProductReviewList {
