...
pub struct ModelResponseOrderList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderListResult>>>,
...
impl ModelResponseOrderList {
    pub fn new() -> ModelResponseOrderList {
