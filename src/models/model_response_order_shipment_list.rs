...
pub struct ModelResponseOrderShipmentList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderShipmentListResult>>>,
...
impl ModelResponseOrderShipmentList {
    pub fn new() -> ModelResponseOrderShipmentList {
