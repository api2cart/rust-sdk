...
pub struct ModelResponseAttributeAttributesetList {
    ...
    pub result: Option<Option<Box<models::ResponseAttributeAttributesetListResult>>>,
...
impl ModelResponseAttributeAttributesetList {
    pub fn new() -> ModelResponseAttributeAttributesetList {
