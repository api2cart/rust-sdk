...
pub struct ModelResponseCustomerCount {
    ...
    pub result: Option<Option<Box<models::ResponseCustomerCountResult>>>,
...
impl ModelResponseCustomerCount {
    pub fn new() -> ModelResponseCustomerCount {
