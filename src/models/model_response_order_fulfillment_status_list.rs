...
pub struct ModelResponseOrderFulfillmentStatusList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderFulfillmentStatusListResult>>>,
...
impl ModelResponseOrderFulfillmentStatusList {
    pub fn new() -> ModelResponseOrderFulfillmentStatusList {
