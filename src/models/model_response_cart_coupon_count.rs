...
pub struct ModelResponseCartCouponCount {
    ...
    pub result: Option<Option<Box<models::ResponseCartCouponCountResult>>>,
...
impl ModelResponseCartCouponCount {
    pub fn new() -> ModelResponseCartCouponCount {
