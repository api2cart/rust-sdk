...
pub struct ModelResponseCartCouponList {
    ...
    pub result: Option<Option<Box<models::ResponseCartCouponListResult>>>,
...
impl ModelResponseCartCouponList {
    pub fn new() -> ModelResponseCartCouponList {
