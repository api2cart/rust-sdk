...
pub struct WebhookUpdate {
    ...
    #[serde(rename = "filtering_conditions", skip_serializing_if = "Option::is_none")]
    pub filtering_conditions: Option<Box<models::ParamDefinitionFilteringConditionsFilterCondition>>,
...
impl WebhookUpdate {
    pub fn new(id: String) -> WebhookUpdate {
        WebhookUpdate {
            id,
            callback: None,
            label: None,
