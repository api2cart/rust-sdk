...
pub struct ModelResponseOrderCount {
    ...
    pub result: Option<Option<Box<models::ResponseOrderCountResult>>>,
...
impl ModelResponseOrderCount {
    pub fn new() -> ModelResponseOrderCount {
