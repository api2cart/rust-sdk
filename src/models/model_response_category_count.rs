...
pub struct ModelResponseCategoryCount {
    ...
    pub result: Option<Option<Box<models::ResponseCategoryCountResult>>>,
...
impl ModelResponseCategoryCount {
    pub fn new() -> ModelResponseCategoryCount {
