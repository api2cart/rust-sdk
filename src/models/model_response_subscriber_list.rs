...
pub struct ModelResponseSubscriberList {
    ...
    pub result: Option<Option<Box<models::ResponseSubscriberListResult>>>,
...
impl ModelResponseSubscriberList {
    pub fn new() -> ModelResponseSubscriberList {
