...
pub struct ModelResponseAttributeList {
    ...
    pub result: Option<Option<Box<models::ResponseAttributeListResult>>>,
...
impl ModelResponseAttributeList {
    pub fn new() -> ModelResponseAttributeList {
