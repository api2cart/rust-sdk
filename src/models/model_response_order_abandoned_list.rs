...
pub struct ModelResponseOrderAbandonedList {
    ...
    pub result: Option<Option<Box<models::ResponseOrderAbandonedListResult>>>,
...
impl ModelResponseOrderAbandonedList {
    pub fn new() -> ModelResponseOrderAbandonedList {
