...
pub struct ProductUpdateBatchPayloadInner {
    #[serde(rename = "id")]
    pub id: String,
    ...
    pub images: Option<Vec<models::ProductUpdateBatchPayloadInnerImagesInner>>,
    /// If an empty array is passed, all entries will be deleted when the 'nested_items_update_behaviour' parameter is set to 'replace'.
...
impl ProductUpdateBatchPayloadInner {
    pub fn new(id: String) -> ProductUpdateBatchPayloadInner {
