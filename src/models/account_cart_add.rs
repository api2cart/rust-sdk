...
pub struct AccountCartAdd {
    ...
    /// nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it.
    #[serde(rename = "nopcommerce_secret", skip_serializing_if = "Option::is_none")]
    pub nopcommerce_secret: Option<String>,
