...
pub async fn account_cart_list(configuration: &configuration::Configuration, params: Option<&str>, exclude: Option<&str>, request_from_date: Option<&str>, request_to_date: Option<&str>, store_url: Option<&str>, store_key: Option<&str>) -> Result<models::AccountCartList200Response, Error<AccountCartListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_params = params;
...
pub async fn account_failed_webhooks(configuration: &configuration::Configuration, count: Option<i32>, start: Option<i32>, ids: Option<&str>) -> Result<models::AccountFailedWebhooks200Response, Error<AccountFailedWebhooksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_count = count;
    let p_start = start;
    let p_ids = ids;
