...
pub async fn account_cart_list(configuration: &configuration::Configuration, store_url: Option<&str>, store_key: Option<&str>, request_from_date: Option<&str>, request_to_date: Option<&str>, custom_label: Option<&str>, params: Option<&str>, exclude: Option<&str>) -> Result<models::AccountCartList200Response, Error<AccountCartListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let p_custom_label = custom_label;
    let p_params = params;
    ...
    if let Some(ref param_value) = p_custom_label {
        req_builder = req_builder.query(&[("custom_label", &param_value.to_string())]);
    }
...
pub async fn account_config_update(configuration: &configuration::Configuration, replace_parameters: Option<bool>, new_store_url: Option<&str>, new_store_key: Option<&str>, custom_label: Option<&str>, bridge_url: Option<&str>, store_root: Option<&str>, db_tables_prefix: Option<&str>, user_agent: Option<&str>, param_3dcart_private_key: Option<&str>, param_3dcart_access_token: Option<&str>, param_3dcartapi_api_key: Option<&str>, amazon_sp_client_id: Option<&str>, amazon_sp_client_secret: Option<&str>, amazon_sp_refresh_token: Option<&str>, amazon_sp_aws_region: Option<&str>, amazon_sp_api_environment: Option<&str>, amazon_seller_id: Option<&str>, aspdotnetstorefront_api_user: Option<&str>, aspdotnetstorefront_api_pass: Option<&str>, americommerce_app_id: Option<&str>, americommerce_app_secret: Option<&str>, americommerce_access_token: Option<&str>, americommerce_refresh_token: Option<&str>, bigcommerceapi_admin_account: Option<&str>, bigcommerceapi_api_path: Option<&str>, bigcommerceapi_api_key: Option<&str>, bigcommerceapi_client_id: Option<&str>, bigcommerceapi_access_token: Option<&str>, bigcommerceapi_context: Option<&str>, bol_api_key: Option<&str>, bol_api_secret: Option<&str>, bol_retailer_id: Option<i32>, demandware_client_id: Option<&str>, demandware_api_password: Option<&str>, demandware_user_name: Option<&str>, demandware_user_password: Option<&str>, ebay_client_id: Option<&str>, ebay_client_secret: Option<&str>, ebay_runame: Option<&str>, ebay_access_token: Option<&str>, ebay_refresh_token: Option<&str>, ebay_environment: Option<&str>, ebay_site_id: Option<i32>, ecwid_acess_token: Option<&str>, ecwid_store_id: Option<&str>, lazada_app_id: Option<&str>, lazada_app_secret: Option<&str>, lazada_refresh_token: Option<&str>, lazada_region: Option<&str>, etsy_keystring: Option<&str>, etsy_shared_secret: Option<&str>, etsy_access_token: Option<&str>, etsy_token_secret: Option<&str>, etsy_client_id: Option<&str>, etsy_refresh_token: Option<&str>, facebook_app_id: Option<&str>, facebook_app_secret: Option<&str>, facebook_access_token: Option<&str>, facebook_business_id: Option<&str>, neto_api_key: Option<&str>, neto_api_username: Option<&str>, shopline_access_token: Option<&str>, shopline_app_key: Option<&str>, shopline_app_secret: Option<&str>, shopline_shared_secret: Option<&str>, shopify_access_token: Option<&str>, shopify_client_id: Option<&str>, shopify_api_key: Option<&str>, shopify_api_password: Option<&str>, shopify_shared_secret: Option<&str>, shopee_partner_id: Option<&str>, shopee_partner_key: Option<&str>, shopee_shop_id: Option<&str>, shopee_refresh_token: Option<&str>, shopee_region: Option<&str>, shopee_environment: Option<&str>, shoplazza_access_token: Option<&str>, shoplazza_shared_secret: Option<&str>, miva_access_token: Option<&str>, miva_signature: Option<&str>, mirakl_api_key: Option<&str>, shopware_access_key: Option<&str>, unas_api_key: Option<&str>, shopware_api_key: Option<&str>, shopware_api_secret: Option<&str>, bigcartel_user_name: Option<&str>, bigcartel_password: Option<&str>, bricklink_consumer_key: Option<&str>, bricklink_consumer_secret: Option<&str>, bricklink_token: Option<&str>, bricklink_token_secret: Option<&str>, nopcommerce_token: Option<&str>, nopcommerce_secret: Option<&str>, volusion_login: Option<&str>, volusion_password: Option<&str>, walmart_client_id: Option<&str>, walmart_client_secret: Option<&str>, walmart_environment: Option<&str>, walmart_channel_type: Option<&str>, walmart_region: Option<&str>, walmart_refresh_token: Option<&str>, walmart_seller_id: Option<&str>, square_client_id: Option<&str>, square_client_secret: Option<&str>, square_refresh_token: Option<&str>, squarespace_api_key: Option<&str>, squarespace_client_id: Option<&str>, squarespace_client_secret: Option<&str>, squarespace_access_token: Option<&str>, squarespace_refresh_token: Option<&str>, hybris_client_id: Option<&str>, hybris_client_secret: Option<&str>, hybris_username: Option<&str>, hybris_password: Option<&str>, hybris_websites: Option<Vec<String>>, lightspeed_api_key: Option<&str>, lightspeed_api_secret: Option<&str>, commercehq_api_key: Option<&str>, commercehq_api_password: Option<&str>, wc_consumer_key: Option<&str>, wc_consumer_secret: Option<&str>, magento_consumer_key: Option<&str>, magento_consumer_secret: Option<&str>, magento_access_token: Option<&str>, magento_token_secret: Option<&str>, prestashop_webservice_key: Option<&str>, wix_app_id: Option<&str>, wix_app_secret_key: Option<&str>, wix_instance_id: Option<&str>, wix_refresh_token: Option<&str>, mercado_libre_app_id: Option<&str>, mercado_libre_app_secret_key: Option<&str>, mercado_libre_refresh_token: Option<&str>, zid_client_id: Option<i32>, zid_client_secret: Option<&str>, zid_access_token: Option<&str>, zid_authorization: Option<&str>, zid_refresh_token: Option<&str>, jumpseller_client_id: Option<&str>, jumpseller_client_secret: Option<&str>, jumpseller_refresh_token: Option<&str>, jumpseller_login: Option<&str>, jumpseller_authtoken: Option<&str>, flipkart_client_id: Option<&str>, flipkart_client_secret: Option<&str>, allegro_client_id: Option<&str>, allegro_client_secret: Option<&str>, allegro_access_token: Option<&str>, allegro_refresh_token: Option<&str>, allegro_environment: Option<&str>, zoho_client_id: Option<&str>, zoho_client_secret: Option<&str>, zoho_refresh_token: Option<&str>, zoho_region: Option<&str>, tiendanube_user_id: Option<i32>, tiendanube_access_token: Option<&str>, tiendanube_client_secret: Option<&str>, otto_client_id: Option<&str>, otto_client_secret: Option<&str>, otto_app_id: Option<&str>, otto_refresh_token: Option<&str>, otto_environment: Option<&str>, otto_access_token: Option<&str>, tiktokshop_app_key: Option<&str>, tiktokshop_app_secret: Option<&str>, tiktokshop_refresh_token: Option<&str>, tiktokshop_access_token: Option<&str>, salla_client_id: Option<&str>, salla_client_secret: Option<&str>, salla_refresh_token: Option<&str>, salla_access_token: Option<&str>, temu_app_key: Option<&str>, temu_app_secret: Option<&str>, temu_access_token: Option<&str>, temu_region: Option<&str>, scapi_client_id: Option<&str>, scapi_client_secret: Option<&str>, scapi_organization_id: Option<&str>, scapi_short_code: Option<&str>, scapi_scopes: Option<&str>, idempotency_key: Option<&str>) -> Result<models::AccountConfigUpdate200Response, Error<AccountConfigUpdateError>> {
    ...
    let p_shopify_client_id = shopify_client_id;
    ...
    let p_mirakl_api_key = mirakl_api_key;
    ...
    let p_nopcommerce_token = nopcommerce_token;
    let p_nopcommerce_secret = nopcommerce_secret;
    ...
    let p_walmart_refresh_token = walmart_refresh_token;
    let p_walmart_seller_id = walmart_seller_id;
    ...
    let p_jumpseller_client_id = jumpseller_client_id;
    let p_jumpseller_client_secret = jumpseller_client_secret;
    let p_jumpseller_refresh_token = jumpseller_refresh_token;
    let p_jumpseller_login = jumpseller_login;
    let p_jumpseller_authtoken = jumpseller_authtoken;
    ...
    let p_scapi_client_id = scapi_client_id;
    let p_scapi_client_secret = scapi_client_secret;
    let p_scapi_organization_id = scapi_organization_id;
    let p_scapi_short_code = scapi_short_code;
    let p_scapi_scopes = scapi_scopes;
    ...
    if let Some(ref param_value) = p_shopify_client_id {
        req_builder = req_builder.query(&[("shopify_client_id", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_mirakl_api_key {
        req_builder = req_builder.query(&[("mirakl_api_key", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_nopcommerce_token {
        req_builder = req_builder.query(&[("nopcommerce_token", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_nopcommerce_secret {
        req_builder = req_builder.query(&[("nopcommerce_secret", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_walmart_refresh_token {
        req_builder = req_builder.query(&[("walmart_refresh_token", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_walmart_seller_id {
        req_builder = req_builder.query(&[("walmart_seller_id", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_jumpseller_client_id {
        req_builder = req_builder.query(&[("jumpseller_client_id", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_jumpseller_client_secret {
        req_builder = req_builder.query(&[("jumpseller_client_secret", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_jumpseller_refresh_token {
        req_builder = req_builder.query(&[("jumpseller_refresh_token", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_jumpseller_login {
        req_builder = req_builder.query(&[("jumpseller_login", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_jumpseller_authtoken {
        req_builder = req_builder.query(&[("jumpseller_authtoken", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_scapi_client_id {
        req_builder = req_builder.query(&[("scapi_client_id", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_scapi_client_secret {
        req_builder = req_builder.query(&[("scapi_client_secret", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_scapi_organization_id {
        req_builder = req_builder.query(&[("scapi_organization_id", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_scapi_short_code {
        req_builder = req_builder.query(&[("scapi_short_code", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_scapi_scopes {
        req_builder = req_builder.query(&[("scapi_scopes", &param_value.to_string())]);
    }
