...
*AnalyticsApi* | [**analytics_customer_report**](docs/AnalyticsApi.md#analytics_customer_report) | **GET** /analytics.customer_report.json | analytics.customer_report
*AnalyticsApi* | [**analytics_product_report**](docs/AnalyticsApi.md#analytics_product_report) | **GET** /analytics.product_report.json | analytics.product_report
*AnalyticsApi* | [**analytics_report**](docs/AnalyticsApi.md#analytics_report) | **GET** /analytics.report.json | analytics.report
...
*CategoryApi* | [**category_delete_batch**](docs/CategoryApi.md#category_delete_batch) | **POST** /category.delete.batch.json | category.delete.batch
...
*OrderApi* | [**order_shipment_event_add**](docs/OrderApi.md#order_shipment_event_add) | **POST** /order.shipment.event.add.json | order.shipment.event.add
*OrderApi* | [**order_shipment_event_list**](docs/OrderApi.md#order_shipment_event_list) | **GET** /order.shipment.event.list.json | order.shipment.event.list
...
## Documentation For Models
 ...
 - [AccountSupportedPlatform](docs/AccountSupportedPlatform.md)
 - [AccountSupportedPlatformParams](docs/AccountSupportedPlatformParams.md)
 - [AccountSupportedPlatformParamsRequiredInnerInner](docs/AccountSupportedPlatformParamsRequiredInnerInner.md)
 - [AnalyticsCustomer](docs/AnalyticsCustomer.md)
 - [AnalyticsCustomerMetric](docs/AnalyticsCustomerMetric.md)
 - [AnalyticsInterval](docs/AnalyticsInterval.md)
 - [AnalyticsMetric](docs/AnalyticsMetric.md)
 - [AnalyticsPeriod](docs/AnalyticsPeriod.md)
 - [AnalyticsProduct](docs/AnalyticsProduct.md)
 - [AnalyticsProductMetric](docs/AnalyticsProductMetric.md)
 ...
 - [Media](docs/Media.md)
 - [ModelResponseAccountSupportedPlatforms](docs/ModelResponseAccountSupportedPlatforms.md)
 - [ModelResponseAttributeAttributesetList](docs/ModelResponseAttributeAttributesetList.md)
 - [ModelResponseAttributeCount](docs/ModelResponseAttributeCount.md)
 ...
 - [ModelResponseAttributeTypeList](docs/ModelResponseAttributeTypeList.md)
 - [ModelResponseBatchJobList](docs/ModelResponseBatchJobList.md)
 - [ModelResponseCartCatalogPriceRulesCount](docs/ModelResponseCartCatalogPriceRulesCount.md)
 - [ModelResponseCartCatalogPriceRulesList](docs/ModelResponseCartCatalogPriceRulesList.md)
 - [ModelResponseCartCouponCount](docs/ModelResponseCartCouponCount.md)
 ...
 - [ModelResponseCartGiftcardCount](docs/ModelResponseCartGiftcardCount.md)
 - [ModelResponseCartMetaDataList](docs/ModelResponseCartMetaDataList.md)
 - [ModelResponseCartMethods](docs/ModelResponseCartMethods.md)
 ...
 - [ModelResponseCategoryAssign](docs/ModelResponseCategoryAssign.md)
 - [ModelResponseCategoryCount](docs/ModelResponseCategoryCount.md)
 - [ModelResponseCategoryFind](docs/ModelResponseCategoryFind.md)
 - [ModelResponseCategoryList](docs/ModelResponseCategoryList.md)
 - [ModelResponseCategoryUnassign](docs/ModelResponseCategoryUnassign.md)
 - [ModelResponseCustomerAttributeList](docs/ModelResponseCustomerAttributeList.md)
 - [ModelResponseCustomerCount](docs/ModelResponseCustomerCount.md)
 - [ModelResponseCustomerFind](docs/ModelResponseCustomerFind.md)
 ...
 - [ModelResponseOrderCount](docs/ModelResponseOrderCount.md)
 - [ModelResponseOrderFinancialStatusList](docs/ModelResponseOrderFinancialStatusList.md)
 - [ModelResponseOrderFulfillmentStatusList](docs/ModelResponseOrderFulfillmentStatusList.md)
 ...
 - [ModelResponseProductChildItemFind](docs/ModelResponseProductChildItemFind.md)
 - [ModelResponseProductChildItemList](docs/ModelResponseProductChildItemList.md)
 - [ModelResponseProductCount](docs/ModelResponseProductCount.md)
 - [ModelResponseProductCurrencyList](docs/ModelResponseProductCurrencyList.md)
 - [ModelResponseProductFind](docs/ModelResponseProductFind.md)
 ...
 - [ModelResponseReturnActionList](docs/ModelResponseReturnActionList.md)
 - [ModelResponseReturnCount](docs/ModelResponseReturnCount.md)
 - [ModelResponseReturnList](docs/ModelResponseReturnList.md)
 - [ModelResponseReturnReasonList](docs/ModelResponseReturnReasonList.md)
 - [ModelResponseReturnStatusList](docs/ModelResponseReturnStatusList.md)
 ...
 - [ModelResponseWebhookCount](docs/ModelResponseWebhookCount.md)
 - [ModelResponseWebhookEvents](docs/ModelResponseWebhookEvents.md)
 - [Order](docs/Order.md)
 ...
 - [ProductAddPersonalizationQuestionsInner](docs/ProductAddPersonalizationQuestionsInner.md)
 ...
 - [ResponseAccountSupportedPlatformsResult](docs/ResponseAccountSupportedPlatformsResult.md)
 - [ResponseAnalyticsCustomerReportResult](docs/ResponseAnalyticsCustomerReportResult.md)
 - [ResponseAnalyticsProductReportResult](docs/ResponseAnalyticsProductReportResult.md)
 - [ResponseAnalyticsReportResult](docs/ResponseAnalyticsReportResult.md)
 - [ResponseAttributeAttributesetListResult](docs/ResponseAttributeAttributesetListResult.md)
 - [ResponseAttributeCountResult](docs/ResponseAttributeCountResult.md)
 ...
 - [ResponseAttributeTypeListResult](docs/ResponseAttributeTypeListResult.md)
 - [ResponseBatchJobListResult](docs/ResponseBatchJobListResult.md)
 - [ResponseBatchJobResult](docs/ResponseBatchJobResult.md)
 - [ResponseCartCatalogPriceRulesCountResult](docs/ResponseCartCatalogPriceRulesCountResult.md)
 - [ResponseCartCatalogPriceRulesListResult](docs/ResponseCartCatalogPriceRulesListResult.md)
 - [ResponseCartCouponCountResult](docs/ResponseCartCouponCountResult.md)
 - [ResponseCartCouponListResult](docs/ResponseCartCouponListResult.md)
 - [ResponseCartGiftcardCountResult](docs/ResponseCartGiftcardCountResult.md)
 ...
 - [ResponseCartMethodsResult](docs/ResponseCartMethodsResult.md)
 ...
 - [ResponseCategoryAssignResult](docs/ResponseCategoryAssignResult.md)
 - [ResponseCategoryCountResult](docs/ResponseCategoryCountResult.md)
 - [ResponseCategoryFindResult](docs/ResponseCategoryFindResult.md)
 - [ResponseCategoryListResult](docs/ResponseCategoryListResult.md)
 - [ResponseCategoryUnassignResult](docs/ResponseCategoryUnassignResult.md)
 - [ResponseCustomerAttributeListResult](docs/ResponseCustomerAttributeListResult.md)
 - [ResponseCustomerCountResult](docs/ResponseCustomerCountResult.md)
 - [ResponseCustomerFindResult](docs/ResponseCustomerFindResult.md)
 ...
 - [ResponseOrderCountResult](docs/ResponseOrderCountResult.md)
 - [ResponseOrderFinancialStatusListResult](docs/ResponseOrderFinancialStatusListResult.md)
 - [ResponseOrderFulfillmentStatusListResult](docs/ResponseOrderFulfillmentStatusListResult.md)
 ...
 - [ResponseProductChildItemFindResult](docs/ResponseProductChildItemFindResult.md)
 - [ResponseProductChildItemListResult](docs/ResponseProductChildItemListResult.md)
 - [ResponseProductCountResult](docs/ResponseProductCountResult.md)
 - [ResponseProductCurrencyListResult](docs/ResponseProductCurrencyListResult.md)
 - [ResponseProductFindResult](docs/ResponseProductFindResult.md)
 ...
 - [ResponseReturnActionListResult](docs/ResponseReturnActionListResult.md)
 - [ResponseReturnCountResult](docs/ResponseReturnCountResult.md)
 - [ResponseReturnListResult](docs/ResponseReturnListResult.md)
 - [ResponseReturnReasonListResult](docs/ResponseReturnReasonListResult.md)
 - [ResponseReturnStatusListResult](docs/ResponseReturnStatusListResult.md)
 ...
 - [ResponseWebhookCountResult](docs/ResponseWebhookCountResult.md)
 - [ResponseWebhookEventsResult](docs/ResponseWebhookEventsResult.md)
